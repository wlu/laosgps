function init() {
  ...
  ffwdme.on('geoposition:ready', function() {
    var route = new ffwdme.routingService({
      dest: {lat: -33.840009, lng: 151.206570}
    }).fetch();
  });
  ...
  var audioData = {"file": ffwdme.defaults.audioBaseUrl + 'weicn/voice',
                    "meta_data": { "INIT": { "start": 0, "length": 1.3 }, "C": { "start": 1.4, "length": 1.6 }, "TL_now": { "start": 3.4, "length": 1.6 }, "TL_100": {"start": 5.2,"length": 2.4},"TL_500": {"start": 7.8,"length": 1.8},"TL_1000": {"start": 40.01,"length": 8.01},"TSLL_now": {"start": 48.01,"length": 8.01 },"TSLL_100": {"start": 56.01,"length": 8.01},"TSLL_500": {    "start": 64.01,    "length": 8.01  },  "TSLL_1000": {    "start": 72.01,    "length": 8.01  },  "TSHL_now": {    "start": 80.01,    "length": 8.01  },  "TSHL_100": {    "start": 88.01,    "length": 8.01  },  "TSHL_500": {    "start": 96.01,    "length": 8.01  },  "TSHL_1000": {    "start": 104.01,    "length": 8.01  },  "TR_now": {    "start": 9.7,    "length": 1.8  },  "TR_100": {    "start": 11.6,    "length": 1.8  },  "TR_500": {    "start": 13.5,    "length": 1.8  },  "TR_1000": {    "start": 136.01,    "length": 8.01  },  "TSLR_now": {    "start": 144.01,    "length": 8.01  },  "TSLR_100": {    "start": 152.01,    "length": 8.01  },  "TSLR_500": {    "start": 160.01,    "length": 8.01  },  "TSLR_1000": {    "start": 168.01,    "length": 8.01  },  "TSHR_now": {    "start": 176.01,    "length": 8.01  },  "TSHR_100": {    "start": 184.01,    "length": 8.01  },  "TSHR_500": {    "start": 192.01,    "length": 8.01  },  "TSHR_1000": {    "start": 200.01,    "length": 8.01  },  "TU": {    "start": 208.01,    "length": 8.01  },  "C_100": {    "start": 216.01,    "length": 8.01  },  "C_500": {    "start": 224.01,    "length": 8.01  },  "C_1000": {    "start": 232.01,    "length": 8.01  },  "C_LONG":{    "start": 240.01,    "length": 8.01  },  "FINISH":{    "start": 248.01,    "length": 8.01  },  "EXIT1":{    "start": 256.01,    "length": 8.01  },  "EXIT2":{    "start": 264.01,    "length": 8.01  },  "EXIT3":{    "start": 272.01,    "length": 8.01  },  "EXIT4":{    "start": 280.01,    "length": 8.01  },  "EXIT5":{    "start": 288.01,    "length": 8.01  }}};
  ...
  window.widgets = {
    ...
    zoom      : new ffwdme.components.Zoom({ map: map, parent: '#playground', grid: { x: 0, y: 1 }}),
