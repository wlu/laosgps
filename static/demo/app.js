function init() {
  ...
  ffwdme.on('geoposition:ready', function() {
    var route = new ffwdme.routingService({
      start: { lat: -33.810125, lng: 151.183888},
      dest: { lat: -33.807452, lng: 151.180966 }
    }).fetch();
  });
